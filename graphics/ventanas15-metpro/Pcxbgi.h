...
Version 1.4 - 28-Junio-2000
Todas las funciones retornan el valor 0 si no se encuentra el archivo pcx y 1 en caso contrario
...
int PCX::leer_cabecera(int _orden, char *_nombre)
{

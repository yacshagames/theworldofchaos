// PracticaDlg.cpp : implementation file
//
...
CPracticaDlg::CPracticaDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CPracticaDlg::IDD, pParent)
{
...
void CPracticaDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
...
BEGIN_MESSAGE_MAP(CPracticaDlg, CDialog)
...
BOOL CPracticaDlg::OnInitDialog()
...
void CPracticaDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CPracticaDlg::OnQueryDragIcon()
{
...
void CPracticaDlg::OnLButtonDblClk(UINT nFlags, CPoint point) 
{
		Dibuja();
	
	CDialog::OnLButtonDblClk(nFlags, point);
}
void CPracticaDlg::OnButton4() 
{
	// TODO: Add your control notification handler code here
	
}
void CPracticaDlg::OnButton1() 
{  
...
void CPracticaDlg::OnButton2() 
{
	
	RotaY(0.01745329251994);
Dibuja();
}
void CPracticaDlg::OnButton3() 
{
Trasladar(10,10,10);		
}


void CPracticaDlg::OnCancelMode() 
{
...
void CPracticaDlg::Trasladar(double TrasX, double TrasY, double TrasZ)
{
...
void CPracticaDlg::RotaX(double angulo)
{
...
void CPracticaDlg::RotaY(double anguloRY)
{
for(int i=0;i<40;i++)
{
//punto p0
...
void CPracticaDlg::RotaZ(double anguloRZ)
{
for(int i=0;i<45;i++)
{//punto p0
...
void CPracticaDlg::OnCaptureChanged(CWnd *pWnd) 
{
	// TODO: Add your message handler code here

...
void CCuadrado3DDlg::DibujarReflejo()
{
  ...
  for(j=1,i=0;i<4;i++,j++)
   {   
    ...
    dibujo.MoveTo(ox+PuntoReflejado[i][0]*ix+PuntoReflejado[i][1]*jx,
	              oy+PuntoReflejado[i][0]*iy+PuntoReflejado[i][1]*jy+PuntoReflejado[i][2]*zy);  
   
    dibujo.LineTo(ox+PuntoReflejado[j][0]*ix+PuntoReflejado[j][1]*jx,
	              oy+PuntoReflejado[j][0]*iy+PuntoReflejado[j][1]*jy+PuntoReflejado[j][2]*zy);   
   }
}
